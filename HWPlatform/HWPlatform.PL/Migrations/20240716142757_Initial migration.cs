    ...
    public partial class Initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Classes", x => new { x.ClassName, x.Year });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentDetails_Classes_ClassId1_ClassId2",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassesClassName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClassesYear = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassTeacher", x => new { x.TeachersId, x.ClassesClassName, x.ClassesYear });
                    table.ForeignKey(
                        name: "FK_ClassTeacher_Classes_ClassesClassName_ClassesYear",
                        columns: x => new { x.ClassesClassName, x.ClassesYear },
                        principalTable: "Classes",
                        principalColumns: new[] { "ClassName", "Year" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkAssignments_Subjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassTeacher_ClassesClassName_ClassesYear",
                table: "ClassTeacher",
                columns: new[] { "ClassesClassName", "ClassesYear" });
